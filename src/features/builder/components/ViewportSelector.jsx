...
/**
 * Selector de viewport para cambiar entre diferentes tamaños de pantalla
 * @param {string} currentMode - Modo de viewport actual
 * @param {Function} onModeChange - Función para cambiar el modo de viewport
 */
