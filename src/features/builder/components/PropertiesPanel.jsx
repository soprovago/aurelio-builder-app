 ...
 * @param {Object} selectedElement - Elemento seleccionado actualmente
 * @param {Function} onUpdateElement - Función para actualizar propiedades del elemento
 */
function PropertiesPanel({ selectedElement, onUpdateElement }) {
  ...
  return (
    <div className="w-80 bg-[#1a1a1a] border-l border-[#2a2a2a] p-6 overflow-y-auto">
      ...
      {/* Propiedades para texto y encabezado */}
